<x-layout>
    ...
    <div>
        ...
        <div class="flex flex-wrap mx-auto ml-60 mr-60 p-4 {{$key % 2 == 0 ? "bg-indigo-900" : "bg-indigo-950"}}">
            ...
            <button onclick="location.href='{{route('itemDetails',['id' => $item->getKey()])}}'" class="border-2 rounded w-20 h-20 mt-auto mb-auto ml-auto mr-32 bg-amber-300 text-black">BUY</button>
        </div>
        @endforeach
    </div>
