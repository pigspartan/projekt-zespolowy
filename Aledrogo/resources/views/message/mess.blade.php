...
<x-layout>
    <div class="pageContent min-h-screen flex flex-col text-black dark:text-gray-300">
        ...
        <div class="flex flex-1">
            <!-- Lista użytkowników -->
            <div class="w-1/4 bg-gray-300 dark:bg-gray-900 p-4 border rounded-l-xl overflow-y-auto max-h-[calc(100vh-4rem)]">
                ...
                <ul class="space-y-2">
                    ...
                    @for ($i = 1; $i <= 20; $i++)
                        <li class="p-2 bg-gray-200 dark:bg-gray-800 hover:bg-gray-400 dark:hover:bg-gray-700 rounded cursor-pointer">Użytkownik {{ $i }}</li>
                    @endfor
                </ul>
            </div>
            ...
            <div class="w-3/4 bg-gray-300 dark:bg-gray-800 p-4 flex flex-col border-y border-r rounded-r-xl">
                ...
                <div class="mt-4">
                    <input type="text" placeholder="Napisz wiadomość..." class="w-full p-3 defaultInput">
                </div>
            </div>
        </div>
    </div>
